...
<img src="https://img.shields.io/badge/-TypeScript-black?style=for-the-badge&logoColor=white&logo=typescript&color=3178C6"/>
  ...
  <h3 align="center">Stock Market App — Alerts, Charts, AI Insights</h3>
   ...
   <div align="center">
     A modern stock market tracking application with real-time data, AI-powered insights, and intelligent alerts.
    </div>
</div>
...
A modern, AI-powered stock market app built with Next.js, Shadcn, Better Auth, and Inngest. Track real-time stock prices, set personalized alerts, explore detailed company insights, and manage your watchlists efficiently. The admin dashboard provides comprehensive stock management, news publishing, and user activity monitoring, while event-driven workflows power automated alerts, AI-driven daily digests, earnings notifications, and sentiment analysis.
...
- [Finnhub API Documentation](https://finnhub.io/)
- [Inngest Documentation](https://www.inngest.com/)
- [Next.js Documentation](https://nextjs.org/docs)   s t o c k _ t r a c k e r 
 
 